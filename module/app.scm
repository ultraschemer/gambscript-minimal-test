...
(!set! EXPORT-OBJECT 'testProc
       (lambda () 
         ...
         (let ((dt (!xa "new Date")))
           (!sa console.log "New date object: " dt)
           (!sa console.log "Applying date method (getTime): " (!js-expression-call dt 'getTime))
           (!sa console.log "Applying date method (getTime): " (!js-e-call dt 'getTime))
           (!sa console.log "Applying date method (getTime): " (!js-x-call dt 'getTime))
           (!sa console.log "Applying date method (getTime): " (!js-call dt 'getTime))
           (!sa console.log "Applying date method (getTime): " (!call dt 'getTime))
           (!sa console.log "Applying date method (getTime): " (!! dt 'getTime))
           (!sa console.log "Applying date method - raw - (getTime): " (!js-expression-raw-call dt 'getTime))
           (!sa console.log "Applying date method - raw - (getTime): " (!js-e-rcall dt 'getTime))
           (!sa console.log "Applying date method - raw - (getTime): " (!js-x-rcall dt 'getTime))
           (!sa console.log "Applying date method - raw - (getTime): " (!js-rcall dt 'getTime))
           (!sa console.log "Applying date method - raw - (getTime): " (!rcall dt 'getTime))
           (!sa console.log "Applying date method - raw - (getTime): " (!!r dt 'getTime))
           (!js-statement-call dt 'setMonth 1)
           (!sa console.log "Current date object: " dt) 
           (!js-s-call dt 'setMonth 1)
           (!sa console.log "Current date object: " dt) 
           (!s-call dt 'setMonth 2)
           (!sa console.log "Current date object: " dt) 
           (!scall dt 'setMonth 3)
           (!sa console.log "Current date object: " dt) 
           (!!! dt 'setMonth 4)
